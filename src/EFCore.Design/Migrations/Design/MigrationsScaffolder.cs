...
namespace Microsoft.EntityFrameworkCore.Migrations.Design
{
    public class MigrationsScaffolder
    {
            ...
            [CanBeNull] string subNamespace = null)
        {
            ...
            var lastModel = Dependencies.ModelProcessor.Process(modelSnapshot?.Model);
        ...
        public virtual MigrationFiles RemoveMigration([NotNull] string projectDir, [NotNull] string rootNamespace, bool force)
        {
            ...
            if (migrations.Count != 0)
            {
                ...
                if (!Dependencies.MigrationsModelDiffer.HasDifferences(model, Dependencies.ModelProcessor.Process(modelSnapshot.Model)))
                {
                    if (force)
                    {
