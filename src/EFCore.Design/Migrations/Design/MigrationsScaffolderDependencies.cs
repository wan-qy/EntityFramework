...
namespace Microsoft.EntityFrameworkCore.Migrations.Design
{
    ...
    public sealed class MigrationsScaffolderDependencies
    {
        ...
        /// <param name="modelProcessor"> The snapshot model processor. </param>
        public MigrationsScaffolderDependencies(
            ...
            [NotNull] IModelProcessor modelProcessor)
        {
            ...
            Check.NotNull(modelProcessor, nameof(modelProcessor));
        ...
        /// </summary>
        public IModelProcessor ModelProcessor { get; }
        ...
        ///     Clones this dependency parameter object with one service replaced.
        /// </summary>
        /// <param name="modelProcessor"> A replacement for the current dependency of this type. </param>
        /// <returns> A new parameter object with the given service replaced. </returns>
        public MigrationsScaffolderDependencies With([NotNull] IModelProcessor modelProcessor)
            => new MigrationsScaffolderDependencies(
                CurrentDbContext,
                Model,
                MigrationsAssembly,
